            ...
            <div class="col-lg-5 bg-light" style="padding-top:50px;padding-bottom:50px;">
                <div style="margin-left:8px;margin-right:8px">
                    ...
                    <div class="form-sec check2" style="display:none">                        
                        ...
                        <!-- Form-STEEP 2 -->
<!--                        <form id="contactForm" name="sentMessage" novalidate="novalidate">
                            <p class="text-muted">VERIFICAÇÃO DO TELEFONE</p>
                            <div class="row" >
                                <div class="col-lg-6 form-group">
                    ...
                    <div class="form-sec check4" style="display:none"> 
                        ...
                        <form id="contactForm" name="sentMessage" novalidate="novalidate">
                            <div class="form-group">
                                ...
                                <div class="col-lg-12 text-center">
                                    <div class="col-lg-12 text-center">
                                    <button id="btn_steep_4" class="btn btn-primary btn-xl text-uppercase" style="padding:10px" type="submit">Contratar</button>
                                </div>
                                </div>
                            </div>                                   
                        </form>
