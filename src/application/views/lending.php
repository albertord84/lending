  ...
  <body id="page-top">
    ...
    <section  style="padding: 0px">
            <div class="row" style="margin-top: 100px;margin-bottom: 0px">
                <div class="col-lg-3" style="padding:50px;padding-right:20px; background-color:#f5f4f4">
                    <h5 class="subheading">Resumo do empréstimo</h5>
                    <div class="text-left">
                        <span class="text-muted">
                            <small>Valor solicitado por você:</small>
                            <h6 class="">R$ 1000,00<?php echo $solicited_value;?></h6>
                        </span>
                        <span class="text-muted">
                            <small>Quantidade de parcelas:</small>
                            <h6 class=""><?php echo $amount_months;?>10x</h6>
                        </span>
                        <span class="text-muted">
                            <small>Custo por parcela:</small>
                            <h6 class="">R$ 153,00<?php echo $month_value;?> <b class="fw-500"></b></h6>
                        </span>
                        
                        <span class="text-muted">
                            <small>Taxa de juros ao mês:</small>
                            <h6 class=""><?php echo $tax;?>4,99 %</h6>
                        </span>
                        <span class="text-muted">
                            <small>Custo Efetivo Total:</small>
                            <h6 class="">R$ 1530,00<?php echo $total_cust_value;?></h6>
                        </span>
                        <span class="text-muted">
                            <small>IOF:</small>
                            <h6 class="">R$ 17,85<?php echo $IOF;?></h6>
                        </span>
                        
                        <div class="row">                            
                            <span class="col-md-6 col-sm-6 col-xs-12 text-muted">
                                <p class="" style="font-size:0.8em">CET:<br>
                                    <b class="" style="font-size:1.3em"><?php echo $CET_PERC;?>2,95 %</b>
                                </p>
                            </span>
                            <span class="col-md-6 col-sm-6 col-xs-12 text-muted">
                                <p class="" style="font-size:0.8em">CET AO ANO:<br>
                                    <b class="" style="font-size:1.3em"><?php echo $CET_YEAR;?>32,21 %</b>
                                </p>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 bg-light" style="padding-top:50px;padding-bottom:50px;">
                    <div style="margin-left:8px;margin-right:8px">
                        <!-- STEEP 1 -->
                        <div class="form-sec sigin-painel-steep-1" style="display:none">                        
                            <!-- Wizard-STEEP 1 -->
                            ...
                            <form id="contactForm" name="sentMessage" novalidate="novalidate">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input id="name" class="form-control" type="text" placeholder="Nome Completo (como no CPF) *" required="required" data-validation-required-message="Por favor, informe seu nome como aparece no seu CPF." required style="text-transform:uppercase;">
                                        <p class="help-block text-danger"></p>
                                    </div>
                                    <div class="form-group">
                                        <input id="email" class="form-control" type="email" placeholder="Email *" required="required" data-validation-required-message="Por favor, informe seu email.">
                                        <p class="help-block text-danger"></p>
                                    </div>
                                    <div class="form-group">
                                        <input id="cpf" class="form-control" type="text" placeholder="CPF" required="required" data-validation-required-message="Por favor, informe seu CPF.">
                                        <p class="help-block text-danger"></p>
                                    </div>                                
                                    <div class="form-group">
                                        <input id="phone_number" class="form-control" type="tel" placeholder="Telefone *" required="required" data-validation-required-message="Por favor, informe seu CPF.">
                                        <p class="help-block text-danger"></p>
                                    </div> 
                                    <p class="text-muted">SEU ENDEREÇO</p>
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            <input id="cep" type="text" class="form-control" placeholder="CEP *" required="required" data-validation-required-message="Por favor, informe seu CEP.">
                                    ...
                                    <div class="form-group" style="margin-bottom:0px">
                                        <div class="row" >
                                            <div class="col-md-6 col-sm-8 col-xs-12">
                                                <input id="street_address" class="form-control" type="text" placeholder="Rua e Bairro *" required="required" data-validation-required-message="Por favor, informe sua rua.">
                                                <p class="help-block text-danger"></p>                                        
                                            </div>
                                            <div class="col-md-3 col-sm-12 col-xs-12">
                                                <input id="number_address" class="form-control" type="text" placeholder="Número" required="required" data-validation-required-message="Por favor, informe o número ou s/n se não tiver.">
                                            </div>   
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                <input id="complement_number_address" class="form-control" id="phone" type="text" placeholder="Complemento *">
                                                <p class="help-block text-danger"></p>                                        
                                            </div>
                                        </div>                                    
                                    </div>
                                    <div class="form-group" style="margin-top:0px">
                                        <div class="row" >                                        
                                            <div class="col-md-8 col-sm-6 col-xs-12">
                                                <input id="city_address" class="form-control" id="phone" type="text" placeholder="Cidade *" required="required" data-validation-required-message="Por favor, informe sua cidade.">
                                                <p class="help-block text-danger"></p>                                        
                                            </div>                                        
                                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                <input id="state_address" class="form-control" id="phone" type="text" placeholder="UF *" required="required" data-validation-required-message="Por favor, informe sua Unidade Federativa ou Estado.">
                                                <p class="help-block text-danger"></p>                                        
                                            </div>                                        
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 text-center">
                                        <div id="success"></div>
                                        <button id="btn_steep_1" class="btn btn-primary btn-xl text-uppercase" style="padding:15px" type="submit">Seguinte</button>
                                    </div>
                                </div>                                   
                            </form>
                        </div>
                        ...
                        <!-- STEEP 2 -->
                        <div class="form-sec sigin-painel-steep-2" style="display:none">                        
                            <!-- Wizard-STEEP 2 -->
                            ...
                            <form id="contactForm" name="sentMessage" novalidate="novalidate">
                                <div class="form-group">
                                    <p class="text-muted">DADOS DO CARTÂO DE CRÈDITO</p>
                                    <div class="form-group">
                                        <input id="name" class="form-control" type="text" placeholder="Seu nome no cartão *" required="required" data-validation-required-message="Por favor, informe seu nome como aparece no cartão." required style="text-transform:uppercase;">
                                        <p class="help-block text-danger"></p>
                                    </div>
                                    <div class="form-group">
                                        <input id="name" class="form-control" type="text" placeholder="Número do cartão *" required="required" data-validation-required-message="Por favor, informe o número do cartão.">
                                        <p class="help-block text-danger"></p>
                                    </div>                                
                        ...
                        <!-- STEEP 3 -->
                        <div class="form-sec sigin-painel-steep-3"> 
                            <!-- Wizard-STEEP 3 -->
                            <div class="col-md-12 col-md-12 col-xs-12 stepwizard ">
                                <div class="stepwizard-row setup-panel">
                                    <div class="stepwizard-step">
                            ...
                            <form id="contactForm" name="sentMessage" novalidate="novalidate">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input id="name" class="form-control" type="text" placeholder="Nome completo do titular da conta *" required="required" data-validation-required-message="Por favor, informe seu nome como aparece no cartão." required style="text-transform:uppercase;">
                                        <p class="help-block text-danger"></p>
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-bottom:0px">
                                        <div class="row" >
                                            <div class="col-lg-6">
                                                <input id="street_address" class="form-control" type="text" placeholder="Agência *" required="required" data-validation-required-message="Informe agência bancária.">
                                                <p class="help-block text-danger"></p>                                        
                                            </div>
                                            <div class="col-lg-3">
                                                <input id="number_address" class="form-control" type="text" placeholder="Conta *" required="required" data-validation-required-message="Informe o número da conta.">
                                                <p class="help-block text-danger"></p>        
                                            </div>   
                                            <div class="col-lg-3">
                                                <input id="complement_number_address" class="form-control" type="text" placeholder="Dígito *" title="Dígito verificador da conta" required="required" data-validation-required-message="Informe o dígito verificador da conta.">
                                                <p class="help-block text-danger"></p>                                        
                                            </div>
                                        </div>                                    
                                    </div>
                ...
                <div class="col-lg-4" style="padding:50px;">
                    <!-- INFORMATION STEEP 1 -->
                    <div id="information-steep-1" style="visibility:hidden;display:none" class="col-lg-12">
                        <div>
                    ...
                    <!-- INFORMATION STEEP 2 -->
                    <div id="information-steep-2" style="visibility:hidden; display:none" class="col-lg-12">
                        <div>
                            <div class="timeline-heading text-center">
                                <h4 class="subheading">Adicionar dados bancários</h4>
                            </div>
                    ...
                    <!-- INFORMATION STEEP 3 -->
                    <div id="information-steep-3" style="visibility:visible; display:block"  class="col-lg-12">
                        <div>
                            <div class="timeline-heading text-center">
                                <h4 class="subheading">Adicionar dados bancários</h4>
                            </div>
                    ...
                    <!-- INFORMATION STEEP 4 -->
                    <div id="information-steep-4" style="visibility:hidden; display:none" class="col-lg-12">
                        <div>
                            <div class="timeline-heading text-center">
                                <h4 class="subheading">Adicionar dados bancários</h4>
                            </div>
