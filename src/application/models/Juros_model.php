 ...
 * @category CodeIgniter-Model: juros_Model
...
class Juros_model extends CI_Model {
  ...
  function remove($parcelas) {
    ...
    $this->db->delete('juros', array('parcelas' => $parcelas));
  }
  ...
  function update($parcelas, $v100_500, $v501_1000, $v1001_2000, $v2001_3000, $v3001_4000, $v4001_5000) {
    ...
    $this->db->update('juros', $this, array('parcelas' => $parcelas));
  }
