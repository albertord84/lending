...
class Gmail {
    ...
    public function __construct() {
        ...
        $this->_ci->load->model('class/system_config');
        $GLOBALS['sistem_config'] = $this->_ci->system_config->load();
    ...
    public function test($useremail, $username, $subject, $mail) {
        var_dump("Thanks again and forever 1!!!<br>");
        $a = __DIR__ . "HOla    ";
        ver_dump($a);
        var_dump("Thanks again and forever!!!<br>");
    }
    ...
    public function send_client_contact_form($username, $useremail, $userphone, $usermsg) {
        ...
        $file = "http://" . $_SERVER['SERVER_NAME'] . "/lending/src/resources/PT/emails/contact_form.php?username=$username&useremail=$useremail&userphone=$userphone&usermsg=$usermsg";
        //echo $file;
        ...
        $this->mail->msgHTML(@file_get_contents($file));
